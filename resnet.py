...
def ResNet101(nInputChannels=3, os=32, pretrained=False):
    model = ResNet(nInputChannels, Bottleneck, [3, 4, 23, 3], os,
                    pretrained=pretrained, model_path='./model/resnet/pre_train/resnet101-5d3b4d8f.pth')
    return model

def ResNet18(nInputChannels=3, os=32, pretrained=False):
    model = ResNet(nInputChannels, BasicBlock, [2, 2, 2, 2], os,
                    pretrained=pretrained, model_path='./model/resnet/pre_train/resnet18-5c106cde.pth')
    return model

def ResNet34(nInputChannels=3, os=32, pretrained=False):
    model = ResNet(nInputChannels, BasicBlock, [3, 4, 6, 3], os,
                    pretrained=pretrained, model_path='./model/resnet/pre_train/resnet34-333f7ec4.pth')
    return model

def ResNet50(nInputChannels=3, os=32, pretrained=False):
    model = ResNet(nInputChannels, Bottleneck, [3, 4, 6, 3], os,
                    pretrained=pretrained, model_path='./model/resnet/pre_train/resnet50-19c8e357.pth')
    return model
